...
<div class="navbar-default " role="navigation">
    <div>
        <div class="navbar-header"><a style="float:left" class="navbar-brand" href="#"> <span style="padding-right:3px; padding-top: 3px; display:inline-block;">
				...
				<div class="booking-details w3-card-4" style="height: 157px">
					...
					<table class="table table-hover  voc_list ">
						...
						<tbody>
							...
							<tr class="listview">
								<td> 
									<img src="icons/first_class.png" width="70%" onClick="loadFirst();" class="img-responsive voc_list_preview_img" alt="" title="First" />
								</td>
							...
							<tr class="listview">
								<td> 
									<img src="icons/prime.png" width="70%" onClick="loadBusiness();" class="img-responsive voc_list_preview_img" alt="" title="First Prime" />
								</td>
